...
dir_path = '/jet/home/thanhngp/BMS1/sample_ASO_all'
...
#df = pd.DataFrame({'x_test': list(train_data), 'Z': list(Z), 'label': list(labels)})
#df.to_csv('/jet/home/thanhngp/BMS1/combine_latent_vae.csv')

# further dimensionality reduction for plotting
...
im2 = ax2.scatter(Z[:,0], Z[:,1], c=labels, s=5, cmap='jet')
...
#df = pd.DataFrame({'x_test': list(train_data), 'Z': list(Z), 'label': list(labels)})
#df.to_csv('/jet/home/thanhngp/BMS1/combine_latent_rvae.csv')
