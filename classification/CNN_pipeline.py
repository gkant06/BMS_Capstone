# https://medium.com/analytics-vidhya/a-survey-of-convolutional-neural-networks-8bdf74a21a31
...
def cnn_model(train_data, val_data, layers ,epochs, optimizer, loss, metrics, image_size):
    ...
    #history = model.fit(validation_dataset, epochs=epochs, validation_data=train_dataset, callbacks=callbacks)
